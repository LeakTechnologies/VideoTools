...
- Current cycle: `v0.1.1-dev50` — **Media Engine gap closure: comprehensive gap analysis completed (20+ gaps across 4 phases). Phase 0 critical fixes shipped. P1-1 network streaming, P1-2 resume, P1-3 audio delay (A/V offset), P1-6+P1-9 SeekAccuracy+Player Tuning Settings shipped. Remaining Phase 1 items: speed+pitch (P1-4), A-B loop (P1-5), bilinear scaling (P1-7), frame timing overlay (P1-8), growing-file (P1-10), clock drift (P1-11). view.go split + ASS subtitle fixes deferred.** Priorities below.
