...
| **P1-5: A-B loop, P1-8: Frame timing overlay, P1-11: Clock drift** | Various | Future |
| **P1-7: Bilinear scaling** — confirmed SWS_BICUBIC in swscale; docs-only | `internal/media/view.go` | **SHIPPED** |
| **P1-10: Growing-file support** — poll + reload on growth | `internal/ui/inline_player.go` | **SHIPPED** |
...
All 11 Phase 1 items are scoped. 8 shipped so far (P1-1 through P1-4, P1-6, P1-9, P1-10, P1-7).
Remaining:
