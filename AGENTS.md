...
- Current cycle: `v0.1.1-dev50` — **Media Engine gap closure: comprehensive gap analysis completed (20+ gaps across 4 phases). All 11 Phase 1 items shipped. HW decode default-on + error concealment shipped. Player robustness work continues in sequence.** Priorities below.
