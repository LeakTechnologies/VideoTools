...
var frCA = Strings{
	...
	SettingsHWDecodeUnavailable:  "Non Compatible",
	...
	DialogNoLogMsg:           "Aucun journal de conversion disponible.",
	DialogNoConfigMsg:        "Aucune configuration enregistrée pour l'instant. Elle sera sauvegardée automatiquement après votre première modification.",
	DialogSavedToFmt:         "Enregistré dans %s",
	DialogJobCancelledFmt:    "Tâche annulée : %s",
	...
	AudioExtractNow:      "Extraire maintenant",
	AudioAddToQueue:      "Ajouter à la file",
	AudioBrowseForVideo:  "Parcourir une vidéo",
	AudioSelectAll:       "Tout sélectionner",
	AudioDeselectAll:     "Tout désélectionner",
	AudioBatchMode:       "Mode par lot (traiter plusieurs fichiers)",
	AudioAddFiles:        "Ajouter des fichiers",
	AudioClearFiles:      "Effacer",
	AudioNormalization:   "Appliquer la normalisation EBU R128",
	AudioTargetLUFS:      "LUFS cible :",
	AudioTruePeak:        "Pic réel :",
	AudioNoFilesAdded:    "Aucun fichier ajouté",
	AudioFormat:          "Format",
	AudioQuality:         "Qualité",
	AudioNormSection:     "Normalisation",
	AudioOutput:          "Sortie",
	AudioNoTracksFound:   "Aucune piste audio trouvée",
	AudioErrLoadFile:     "Échec du chargement du fichier",
	AudioErrDetectTracks: "Échec de la détection des pistes audio",
	AudioErrNoFile:       "Aucun fichier chargé",
	AudioErrNoTracks:     "Aucune piste audio sélectionnée",
	AudioErrNoBatchFiles: "Aucun fichier ajouté au lot",
	AudioErrOutputDir:    "Échec de la création du répertoire de sortie",
	...
	ConvertSectionDeinterlacing:   "Désentrelacement",
	ConvertActionStart:            "Convertir",
	ConvertActionCancelJob:        "Annuler la tâche en cours",
	ConvertCommandPreview:         "Aperçu de la commande",
	ConvertCoverArtLabel:          "Image de couverture",
	ConvertOutputFileFmt:          "Fichier de sortie : %s",
	ConvertDefaultPathFmt:         "Par défaut : %s",
	ConvertAnalyzeInterlacing:     "Analyser l'entrelacement",
	ConvertAnalyzing:              "Analyse en cours...",
	ConvertDetectCrop:             "Détecter le recadrage",
	ConvertDetecting:              "Détection en cours...",
	ConvertAspectRatioEntry:       "Entrez un ratio comme 1.90 ou 256:135.",
	ConvertRemuxHint:              "Mode remux : copie de flux. Les contrôles d'encodage sont désactivés.",
	...
	ConvertAppendSuffix:            "Ajouter « -convert » au nom de fichier",
	ConvertSmartITC:                "Télécine inverse intelligent",
	ConvertAutoDetectBlackBars:     "Détecter les bandes noires automatiquement",
	ConvertFlipHorizontal:          "Retourner horizontalement (miroir)",
	ConvertFlipVertical:            "Retourner verticalement (à l'envers)",
	ConvertForceAspectMeta:         "Forcer les métadonnées de format (DAR/SAR)",
	ConvertMotionInterp:            "Interpolation de mouvement (plus lent, fluidité accrue)",
	ConvertEnableTwoPass:           "Activer l'encodage en deux passes",
	ConvertDevicePresetHint:        "Applique tous les paramètres d'encodage optimisés pour un appareil cible.",
	ConvertSnippetNoVideoMsg:       "Aucune vidéo en cours. Utilisation du point médian.",
	ConvertSnippetJobQueuedFmt:     "Extrait de %ds ajouté à la file.",
	ConvertSnippetAllQueuedFmt:     "%d extraits ajoutés à la file.\nChacun de %ds.",
	...
	RipLoadDisc:         "Charger le disque",
	RipErrNoDrive:       "Aucun lecteur optique détecté",
	RipErrNoDVD:         "Aucune structure DVD-Vidéo trouvée sur le disque",
	RipDriveNotMounted:  "Aucun disque dans le lecteur",
	RipSelectDriveTitle: "Sélectionner un lecteur de disque",
	...
	RipTitleCardFmt:     "%d chapitres",
	RipTitleAudioOne:    "1 piste audio",
	RipTitleAudioMany:   "%d pistes audio",
	RipTitleSubsOne:     "1 sous-titre",
	RipTitleSubsMany:    "%d sous-titres",
	...
	RipReadyMainFeatureFmt: "Prêt à extraire le film principal : %s",
	RipModeSection:         "Mode d'extraction",
	RipModeScenes:          "Film + bonus (choisir les titres)",
	RipModeMainFeature:     "Film principal uniquement",
	RipModeScenesOnly:      "Segments de scènes uniquement (ignorer le film complet)",
	RipReadyScenesOne:      "Prêt à extraire 1 segment de scène",
	RipReadyScenesManyFmt:  "Prêt à extraire %d segments de scènes",
	...
	RipTitleLabel:       "Titre",
	RipEmbedChapters:    "Intégrer les chapitres",
	RipEmbedChaptersCountFmt: "Intégrer les chapitres (%d)",
	RipEmbedChaptersNone:     "Intégrer les chapitres (aucun sur le disque)",
	RipChapterOnly:           "Extraire uniquement une plage de chapitres",
	RipChapterFrom:           "Du chapitre",
	RipChapterTo:             "Au chapitre",
	RipAllAudioTracks:        "Toutes les pistes audio",
	RipAllAudioTracksLangsFmt: "Toutes les pistes audio (%d : %s)",
	RipAllAudioTracksCountFmt: "Toutes les pistes audio (%d)",
	RipIncludeSubtitles:       "Inclure les sous-titres (bitmap DVD)",
	RipIncludeSubtitlesMP4:    "Inclure les sous-titres (non pris en charge en MP4)",
	RipIncludeSubtitlesNone:   "Inclure les sous-titres (aucun sur le disque)",
	RipIncludeSubtitlesCountFmt: "Inclure les sous-titres (%d flux)",
	RipPreserveMenusFull:      "Préserver les menus (fichiers séparés)",
	RipFullDiscExtraction:     "Extraction complète du disque (DVD-Video avec régénération IFO)",
	RipRegionConversion:       "Conversion de région",
	RipRegionNone:             "Aucune",
	RipRegionPALtoNTSC:        "PAL → NTSC",
	RipRegionNTSCtoPAL:        "NTSC → PAL",
	RipAdvancedOptions:        "Avancé",
	RipTitlesOnDiscFmt:        "Titres sur le disque (%d) — sélectionnez dans le navigateur de contenu",
	...
	ThumbnailOutputMode:         "Mode de sortie",
	ThumbnailModeIndividual:     "Vignettes individuelles",
	ThumbnailModeContactSheet:   "Planche contact",
	ThumbnailModeBoth:           "Les deux",
