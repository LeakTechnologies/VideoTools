...
type Strings struct {
	...
	AuthorRequiresSpumux       string // "spumux required for DVD menus."
	...
	AuthorSpumuxNotFound       string // "spumux not found - DVD menus will be skipped"
	AuthorWindowsSpumuxHint    string // "On Windows, spumux requires WSL or MSYS2"
