...
timeline
    ...
    v0.1.1-dev70 (Current) : **Rip UI polish** — mode radio reworded ("Movie + extras (choose titles)" / "Main feature only", stacked vertically) : title-card info line on one localized line ("N chapters · N audio · N subs", no word-wrap split, no duplicated T##/duration) : subtitle-language picker gains Select All / Deselect All buttons
