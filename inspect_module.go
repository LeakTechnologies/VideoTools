...
func buildInspectView(state *appState) fyne.CanvasObject {
	opts := inspect.Options{
		...
		OnGetFormat:       func() string { return state.inspectFile.Format },
		OnGetVideoCodec:   func() string { return state.inspectFile.VideoCodec },
		OnGetWidth:        func() int { return state.inspectFile.Width },
		OnGetHeight:       func() int { return state.inspectFile.Height },
		OnGetAspectRatio:  func() string { return state.inspectFile.AspectRatioString() },
		OnGetFrameRate:    func() float64 { return state.inspectFile.FrameRate },
		OnGetBitrate:      func() int64 { return int64(state.inspectFile.Bitrate) },
		OnGetPixelFormat:  func() string { return state.inspectFile.PixelFormat },
		OnGetColorSpace:   func() string { return state.inspectFile.ColorSpace },
		OnGetColorRange:   func() string { return state.inspectFile.ColorRange },
		OnGetFieldOrder:   func() string { return state.inspectFile.FieldOrder },
		OnGetGOPSize:      func() int { return state.inspectFile.GOPSize },
		OnGetAudioCodec:   func() string { return state.inspectFile.AudioCodec },
		OnGetAudioBitrate: func() int64 { return int64(state.inspectFile.AudioBitrate) },
		OnGetAudioRate:    func() int { return state.inspectFile.AudioRate },
		OnGetChannels:     func() int { return state.inspectFile.Channels },
		OnGetDuration:     func() string { return state.inspectFile.DurationString() },
		OnGetSampleAspect: func() string { return state.inspectFile.SampleAspectRatio },
		OnGetHasChapters:  func() bool { return state.inspectFile.HasChapters },
		OnGetHasMetadata:  func() bool { return state.inspectFile.HasMetadata },
	}
